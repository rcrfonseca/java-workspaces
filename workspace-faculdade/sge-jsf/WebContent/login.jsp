...
<hr>
  <h:form>
    ...
    <h:panelGrid columns="2" >
      ...
      <h:inputText id="login" value="#{loginMB.usuario.login}" required="true" requiredMessage="campo login obrigatório" />
      <h:outputText  value="Digite a senha" />
      <h:inputSecret id="senha" value="#{loginMB.usuario.senha}"  required="true" requiredMessage="campo senha obrigatório"/>
