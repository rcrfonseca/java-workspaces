...
<title>Página Registrar Saída</title>
</head>
<body>

<form action="registrar_saida.jsp" method="post">

<fieldset><legend>Registrar Saída</legend>
...
<table>
	...
	<tr>
		...
		<td><input type="text" value="" name="horario_saida" size="20"></td>
	...
	<tr>
		...
		<td><input type="text" value="" name="valor" size="10"></td>
