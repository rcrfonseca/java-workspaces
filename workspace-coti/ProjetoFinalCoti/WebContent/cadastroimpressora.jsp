...
<title> Sistema de Inventário de Computadores e Impressoras - Cadastrar Impressora </title>
...
<body>
	...
	<div id="site">
        ...
        <form name="form" method="post" action="ControleImpressora">
        	<table>
            	<tr>
                	<td> Nome da Impressora na Intranet: </td>
                ...
                <tr>
                	<td> <br/> <input id="botao" type="button" value="Cadastrar Impressora" onclick="validaImpressora()"/> </td>
		...
		<table id="datagrid" cellspacing="0">
			...
			<%
				try {
					...
					for (entity.Impressora i : id.findByAll()) {
						
						out.print("<tr>");
						out.print("<td>" + i.getNome() + "</td>");
						out.print("<td>" + i.getMarca() + "</td>");
						out.print("<td>" + i.getModelo() + "</td>");
						out.print("<td>" + i.getConexao() + "</td>");
						out.print("<td><a href=ControleImpressora?action=alteracao&nome="+i.getNome()+"> Alterar </a></td>");
						out.print("<td><a href=ControleImpressora?action=delecao&nome="+i.getNome()+"> Deletar </a></td>");
						out.print("</tr>");
					}
